...
input[type=text], input[type=password] {
  ...
  border-bottom:1px solid #0e1d82;
}
...
<!-- <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed "  data-ktheader-minimize="on"  style=" background-color: #808080;height: 40px;">
  ...
  <form class="modal-content" action="" method="post">
    ...
    <div class="container" style="line-height:400%;color:#525150;">
      <label for="email" style=" font-size: 1.2rem;" i class="fa fa-user">&nbsp;&nbsp;<b>USERNAME:</b></label>
      <input class="form-control" type="text"  placeholder="Email" id="email" name="email" autocomplete="off" ><br>
