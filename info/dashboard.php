...
width:100%;
      ...
      ?>
       <body  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading" style="background-color: #F6F5F5;overflow-x:hidden;">
...
<div class="row">
  <div class="col-md-3">
    ...
    <label style="border: 1px #ffffff;width: 100%; height: 150px; padding-left: 10%; padding-top: 13%;background-color:white;" id="shadow">
 ...
 if($rows=mysqli_fetch_assoc($result2)) {
  ...
  <div class="col-md-3">
    ...
    <label style="border: 1px #ffffff; background-color:white;width: 100%; height: 150px; padding-left: 10%; padding-top: 12%;" id="shadow">
      <!-- background color -->
