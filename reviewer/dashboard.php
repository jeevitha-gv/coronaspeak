...
<div class="row">
  <div class="col-md-3">
    ...
    <a href="/coronaspeak/reviewer/noOfNewWhistle.php" style="color: #5D4E4F;">
 ...
 if($rows=mysqli_fetch_assoc($result)) {
  ...
  <div class="col-md-3">
     <a href="/coronaspeak/reviewer/noOfInvestigatedWhistle.php" style="color: #5D4E4F;">
    <label style="border: 1px #ffffff; width: 100%; height: 150px; padding-left: 10%; padding-top: 12%;background-color:white;  "  id="shadow">
      <span class="kt-widget17__icon">
 ...
 if($rows=mysqli_fetch_assoc($result1)) {
  ...
  <div class="col-md-3">
    <a href="/coronaspeak/reviewer/noOfNewIdea.php" style="color: #5D4E4F;">
    <label style="border: 1px #ffffff;width: 100%; height: 150px; padding-left: 10%; padding-top: 12%;background-color:white;  "  id="shadow">
      <span class="kt-widget17__icon">
 ...
 if($rows=mysqli_fetch_assoc($result2)) {
  ...
  <div class="col-md-3">
    <a href="/coronaspeak/reviewer/noOfAnalystIdea.php" style="color: #5D4E4F;">
    <label style="border: 1px #ffffff;width: 100%; height: 150px; padding-left: 10%; padding-top: 12%;background-color:white;"  id="shadow">
      <!-- background color -->
