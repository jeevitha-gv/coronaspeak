...
jQuery(document).ready(function() {
 ...
 var table = $('#kt_table_1').DataTable({
      lengthChange: false,
      ajax: {
          url: "https://5d1b152edd81710014e8825d.mockapi.io/fixnix/user",
          dataSrc: ''
      },
      ...
      columns: [
          ...
          { data: "name"},
            { data: "email"},
              ...
              {data:"Description"},
              // {data:"monetaryValue"}
              {defaultContent:"New Idea"},
             { defaultContent: "<a class='btn btn-primary' style='color:white;'>Analyse</a>"}
     ...
     $('#kt_table_1 tbody').on( 'click', 'a', function () {
      var data = table.row( $(this).parents('tr') ).data();
      // alert(data["tipNo"] );
      window.location='idea/index.php?id='+data["id"];
