<?php
  ...
  $query="SELECT * FROM `case` where status='Reported' and heat='low' order by id desc";
       ...
       <td><?php echo $rows['phone'];?></td>
        <td><?php echo $rows['heat'];?></td>
         ...
         <td><button class="btn btn-warning" style="border-radius: 50px;height: 20px; padding: 1%;" ><?php echo $rows['status'];?></button></td>
           <td><button type="button" class="btn btn-primary"><a href="reviewer/index.php?id=<?php echo $rows['ran'];?>" style="color: white;"> Review</a></button></td>
  </tr>
</tbody>
<?php
}
