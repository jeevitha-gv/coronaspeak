                      ...
                      <select name="country" class="form-control">
                       ...
                       <!--  <div class="kt-wizard-v4__content" data-ktwizard-type="step-content">
                        ...
                        <div class="kt-form__actions">
                            ...
                            <div class="btn btn-success btn-md btn-tall btn-wide kt-font-bold " data-ktwizard-type="action-submit" id="managerUserButton" onclick="manageUser()" style="background-color:#afd135;color: white;border:none;">
                                Submit
                            </div>
